...
def test_missing_session_stays_not_found(monkeypatch) -> None:  # type: ignore[no-untyped-def]
...
def test_key_error_is_not_mapped_to_not_found(monkeypatch) -> None:  # type: ignore[no-untyped-def]
