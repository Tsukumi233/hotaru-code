...
_EXPORTS: Dict[str, Tuple[str, str]] = {
    ...
    "MessageUpdated": (".events", "MessageUpdated"),
    "MessageUpdatedProperties": (".events", "MessageUpdatedProperties"),
    "MessagePartUpdated": (".events", "MessagePartUpdated"),
    "MessagePartUpdatedProperties": (".events", "MessagePartUpdatedProperties"),
    "MessagePartDelta": (".events", "MessagePartDelta"),
    "MessagePartDeltaProperties": (".events", "MessagePartDeltaProperties"),
    "SessionCreated": (".events", "SessionCreated"),
    "SessionCreatedProperties": (".events", "SessionCreatedProperties"),
    "SessionUpdated": (".events", "SessionUpdated"),
    "SessionUpdatedProperties": (".events", "SessionUpdatedProperties"),
    "SessionDeleted": (".events", "SessionDeleted"),
    "SessionDeletedProperties": (".events", "SessionDeletedProperties"),
    "SessionStatus": (".events", "SessionStatus"),
    "SessionStatusProperties": (".events", "SessionStatusProperties"),
    "LLM": (".llm", "LLM"),
    "StreamInput": (".llm", "StreamInput"),
    "StreamChunk": (".llm", "StreamChunk"),
    "StreamResult": (".llm", "StreamResult"),
    "SessionProcessor": (".processor", "SessionProcessor"),
    "ProcessorResult": (".processor_types", "ProcessorResult"),
    "ToolCallState": (".processor_types", "ToolCallState"),
